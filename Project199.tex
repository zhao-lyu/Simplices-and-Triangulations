...
\usepackage{amsmath, mathtools, amsfonts,amssymb,flexisym,enumitem,grffile,graphicx,tikz,subcaption}
\usepackage{tikz}
...
\begin{document}
  ...
  \bibliography{Bib}
    ...
    -Simplicial complex is always consistent by definition as touch edge is always a subsimplex...
