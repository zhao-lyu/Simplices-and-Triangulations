    ...
    \centering
      ...
      \fill[black!20, draw=black, thick] (B'') circle (1pt) node[black, above right] {$p$};
    ...
    \tkzDefPoint(1.5,0){C}
    \tkzDrawSegments(A,B B,C A,C)
    \tkzDefMidPoint(A,B) \tkzGetPoint{peak1}
    %\tkzLabelPoints[left](peak)
    \fill[black!20, draw=black, thick] (peak1) circle (1pt) node[black, above right] {$p$};
    \tkzDefMidPoint(B,C) \tkzGetPoint{peak2}
    %\tkzLabelPoints[right](peak)
    \fill[black!20, draw=black, thick] (peak2) circle (1pt) node[black, above right] {$p$};
    ...
    \tkzDrawSegment(ac',ab')
    \tkzDrawSegment(ac',bc')
    \tkzDefMidPoint(B',ac') \tkzGetPoint{peaka}
    %\tkzLabelPoints[above,yshift=0pt](peak)
    \fill[black!20, draw=black, thick] (peaka) circle (1pt) node[black, above right] {$p$};
    \tkzDefMidPoint(A',ac') \tkzGetPoint{peakb}
    %\tkzLabelPoints[below](peak)
    \fill[black!20, draw=black, thick] (peakb) circle (1pt) node[black, above right] {$p$};
    \tkzDefMidPoint(C',ac') \tkzGetPoint{peakc}    
    %\tkzLabelPoints[below](peak)
    \fill[black!20, draw=black, thick] (peakc) circle (1pt) node[black, above right] {$p$};
