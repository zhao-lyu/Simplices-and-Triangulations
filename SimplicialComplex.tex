...
\subsection{Simplicial Complexes}
    ...
    \caption{Simplicial complex(left); Not simplicial complex(right)\\The two arrangements of simplices on the right are not simplicial complexes because their intersection $x$ and $y$ are not shared. We call such nodes like $x$ and $y$ hanging node.}%cite???
    \label{Fig2}
    \end{figure}
    \end{definition}
